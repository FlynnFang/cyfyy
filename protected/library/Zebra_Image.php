...
class Zebra_Image
{
    ...
    function __construct()
    {
        ...
        $this->enlarge_smaller_images = false;
        
        $this->preserve_aspect_ratio = $this->preserve_time = true;
     ...
     * @param unknown_type $target_path
     */
    public function getErrorMessage($error_code, $source_path, $target_path)
    {
        ...
        switch ($error_code) {
            ...
            case 1:
                $errmsg = 'Source file "' . $source_path . '" could not be found!';
                break;
            case 2:
                $errmsg = 'Source file "' . $source_path . '" is not readable!';
                break;
            case 3:
                $errmsg = 'Could not write target file "' . $source_path . '"!';
                break;
            case 4:
                $errmsg = $source_path . '" is an unsupported source file format!';
                break;
            case 5:
                $errmsg = $target_path . '" is an unsupported target file format!';
                break;
            case 6:
                $errmsg = 'GD library version does not support target file format!';
                break;
            case 7:
                $errmsg = 'GD library is not installed!';
                break;
            case 8:
                $errmsg = '"chmod" command is disabled via configuration!';
                break;
